...
// This now uses an <img> tag to display your logo from a URL.
const Logo = () => (
          ...
          <div className="flex items-center space-x-4">
            {isAuthenticated ? (
              <div className="hidden md:flex items-center gap-4">
                ...
                <a href="#" onClick={() => onNavigate('inbox')} className="text-sm text-purple-600 hover:underline">Inbox</a> {/* <-- ADD THIS LINE */}
